...
namespace Lingu.Bootstrap
{
	...
	public class LinguParser : LRkParser
	{
		...
		private static readonly Symbol[] variables = {
			new Symbol(0x001F, "file"), 
			new Symbol(0x0020, "cf_grammar"), 
			new Symbol(0x0021, "grammar_options"), 
			new Symbol(0x0022, "option"), 
			new Symbol(0x0023, "grammar_terminals"), 
			new Symbol(0x0024, "terminal_item"), 
			new Symbol(0x0025, "terminal_rule"), 
			new Symbol(0x0026, "terminal_fragment"), 
			new Symbol(0x0027, "terminal_context"), 
			new Symbol(0x0028, "terminal_definition"), 
			new Symbol(0x0029, "terminal_def_restrict"), 
			new Symbol(0x002A, "terminal_def_fragment"), 
			new Symbol(0x002B, "terminal_def_repetition"), 
			new Symbol(0x002C, "terminal_def_element"), 
			new Symbol(0x002D, "terminal_def_atom"), 
			new Symbol(0x002E, "terminal_def_cardinalilty"), 
			new Symbol(0x002F, "grammar_rules"), 
			new Symbol(0x0030, "cf_rule"), 
			new Symbol(0x0031, "cf_rule_simple"), 
			new Symbol(0x0032, "rule_definition"), 
			new Symbol(0x0033, "rule_def_choice"), 
			new Symbol(0x0034, "rule_def_fragment"), 
			new Symbol(0x0035, "rule_def_repetition"), 
			new Symbol(0x0036, "rule_def_tree_action"), 
			new Symbol(0x0037, "rule_def_element"), 
			new Symbol(0x0038, "rule_def_atom"), 
			new Symbol(0x0039, "rule_def_context"), 
			new Symbol(0x003A, "rule_def_sub"), 
			new Symbol(0x003B, "rule_sym_action"), 
			new Symbol(0x003C, "rule_sym_virtual"), 
			new Symbol(0x003D, "rule_sym_ref_simple"), 
			new Symbol(0x003E, "rule_sym_ref_template"), 
			new Symbol(0x003F, "rule_sym_ref_params"), 
			new Symbol(0x0040, "cf_rule_template"), 
			new Symbol(0x0041, "rule_template_params"), 
		...
		public static void VisitASTNode(ASTNode node, Visitor visitor)
		{
			...
			switch(node.Symbol.ID)
			{
				...
				case 0x001F: visitor.OnVariableFile(node); break;
				case 0x0020: visitor.OnVariableCfGrammar(node); break;
				case 0x0021: visitor.OnVariableGrammarOptions(node); break;
				case 0x0022: visitor.OnVariableOption(node); break;
				case 0x0023: visitor.OnVariableGrammarTerminals(node); break;
				case 0x0024: visitor.OnVariableTerminalItem(node); break;
				case 0x0025: visitor.OnVariableTerminalRule(node); break;
				case 0x0026: visitor.OnVariableTerminalFragment(node); break;
				case 0x0027: visitor.OnVariableTerminalContext(node); break;
				case 0x0028: visitor.OnVariableTerminalDefinition(node); break;
				case 0x0029: visitor.OnVariableTerminalDefRestrict(node); break;
				case 0x002A: visitor.OnVariableTerminalDefFragment(node); break;
				case 0x002B: visitor.OnVariableTerminalDefRepetition(node); break;
				case 0x002C: visitor.OnVariableTerminalDefElement(node); break;
				case 0x002D: visitor.OnVariableTerminalDefAtom(node); break;
				case 0x002E: visitor.OnVariableTerminalDefCardinalilty(node); break;
				case 0x002F: visitor.OnVariableGrammarRules(node); break;
				case 0x0030: visitor.OnVariableCfRule(node); break;
				case 0x0031: visitor.OnVariableCfRuleSimple(node); break;
				case 0x0032: visitor.OnVariableRuleDefinition(node); break;
				case 0x0033: visitor.OnVariableRuleDefChoice(node); break;
				case 0x0034: visitor.OnVariableRuleDefFragment(node); break;
				case 0x0035: visitor.OnVariableRuleDefRepetition(node); break;
				case 0x0036: visitor.OnVariableRuleDefTreeAction(node); break;
				case 0x0037: visitor.OnVariableRuleDefElement(node); break;
				case 0x0038: visitor.OnVariableRuleDefAtom(node); break;
				case 0x0039: visitor.OnVariableRuleDefContext(node); break;
				case 0x003A: visitor.OnVariableRuleDefSub(node); break;
				case 0x003B: visitor.OnVariableRuleSymAction(node); break;
				case 0x003C: visitor.OnVariableRuleSymVirtual(node); break;
				case 0x003D: visitor.OnVariableRuleSymRefSimple(node); break;
				case 0x003E: visitor.OnVariableRuleSymRefTemplate(node); break;
				case 0x003F: visitor.OnVariableRuleSymRefParams(node); break;
				case 0x0040: visitor.OnVariableCfRuleTemplate(node); break;
				case 0x0041: visitor.OnVariableRuleTemplateParams(node); break;
				case 0x004E: visitor.OnVirtualConcat(node); break;
