...
namespace Lingu.Bootstrap
{
	...
	public class LinguParser : LRkParser
	{
		...
		public class ID
		{
			...
			/// </summary>
			public const int VariableFile = 0x001B;
			/// <summary>
			/// The unique identifier for variable cf_grammar
			/// </summary>
			public const int VariableCfGrammar = 0x001C;
			/// <summary>
			/// The unique identifier for variable grammar_options
			/// </summary>
			public const int VariableGrammarOptions = 0x001D;
			/// <summary>
			/// The unique identifier for variable option
			/// </summary>
			public const int VariableOption = 0x001E;
			/// <summary>
			/// The unique identifier for variable grammar_terminals
			/// </summary>
			public const int VariableGrammarTerminals = 0x001F;
			/// <summary>
			/// The unique identifier for variable terminal_item
			/// </summary>
			public const int VariableTerminalItem = 0x0020;
			/// <summary>
			/// The unique identifier for variable terminal_rule
			/// </summary>
			public const int VariableTerminalRule = 0x0021;
			/// <summary>
			/// The unique identifier for variable terminal_fragment
			/// </summary>
			public const int VariableTerminalFragment = 0x0022;
			/// <summary>
			/// The unique identifier for variable terminal_context
			/// </summary>
			public const int VariableTerminalContext = 0x0023;
			/// <summary>
			/// The unique identifier for variable terminal_definition
			/// </summary>
			public const int VariableTerminalDefinition = 0x0024;
			/// <summary>
		...
		private static readonly Symbol[] variables = {
			new Symbol(0x001B, "file"), 
			new Symbol(0x001C, "cf_grammar"), 
			new Symbol(0x001D, "grammar_options"), 
			new Symbol(0x001E, "option"), 
			new Symbol(0x001F, "grammar_terminals"), 
			new Symbol(0x0020, "terminal_item"), 
			new Symbol(0x0021, "terminal_rule"), 
			new Symbol(0x0022, "terminal_fragment"), 
			new Symbol(0x0023, "terminal_context"), 
			new Symbol(0x0024, "terminal_definition"), 
			new Symbol(0x0025, "terminal_def_restrict"), 
			new Symbol(0x0026, "terminal_def_fragment"), 
			new Symbol(0x0027, "terminal_def_repetition"), 
			new Symbol(0x0028, "terminal_def_element"), 
			new Symbol(0x0029, "terminal_def_atom"), 
			new Symbol(0x002A, "terminal_def_cardinalilty"), 
			new Symbol(0x002B, "grammar_rules"), 
			new Symbol(0x002C, "rule"), 
			new Symbol(0x002D, "rule_simple"), 
			new Symbol(0x002E, "rule_template"), 
			new Symbol(0x002F, "rule_definition"), 
			new Symbol(0x0030, "rule_def_choice"), 
			new Symbol(0x0031, "rule_def_fragment"), 
			new Symbol(0x0032, "rule_def_repetition"), 
			new Symbol(0x0033, "rule_def_tree_action"), 
			new Symbol(0x0034, "rule_def_element"), 
			new Symbol(0x0035, "rule_def_atom"), 
			new Symbol(0x0036, "rule_def_context"), 
			new Symbol(0x0037, "rule_def_sub"), 
			new Symbol(0x0038, "rule_sym_action"), 
			new Symbol(0x0039, "rule_sym_virtual"), 
			new Symbol(0x003A, "rule_sym_ref_simple"), 
			new Symbol(0x003B, "rule_sym_ref_template"), 
			new Symbol(0x003C, "rule_sym_ref_params"), 
			new Symbol(0x003D, "rule_template_params"), 
		...
		public static void VisitASTNode(ASTNode node, Visitor visitor)
		{
			...
			switch(node.Symbol.ID)
			{
				...
				case 0x001B: visitor.OnVariableFile(node); break;
				case 0x001C: visitor.OnVariableCfGrammar(node); break;
				case 0x001D: visitor.OnVariableGrammarOptions(node); break;
				case 0x001E: visitor.OnVariableOption(node); break;
				case 0x001F: visitor.OnVariableGrammarTerminals(node); break;
				case 0x0020: visitor.OnVariableTerminalItem(node); break;
				case 0x0021: visitor.OnVariableTerminalRule(node); break;
				case 0x0022: visitor.OnVariableTerminalFragment(node); break;
				case 0x0023: visitor.OnVariableTerminalContext(node); break;
				case 0x0024: visitor.OnVariableTerminalDefinition(node); break;
				case 0x0025: visitor.OnVariableTerminalDefRestrict(node); break;
				case 0x0026: visitor.OnVariableTerminalDefFragment(node); break;
				case 0x0027: visitor.OnVariableTerminalDefRepetition(node); break;
				case 0x0028: visitor.OnVariableTerminalDefElement(node); break;
				case 0x0029: visitor.OnVariableTerminalDefAtom(node); break;
				case 0x002A: visitor.OnVariableTerminalDefCardinalilty(node); break;
				case 0x002B: visitor.OnVariableGrammarRules(node); break;
				case 0x002C: visitor.OnVariableRule(node); break;
				case 0x002D: visitor.OnVariableRuleSimple(node); break;
				case 0x002E: visitor.OnVariableRuleTemplate(node); break;
				case 0x002F: visitor.OnVariableRuleDefinition(node); break;
				case 0x0030: visitor.OnVariableRuleDefChoice(node); break;
				case 0x0031: visitor.OnVariableRuleDefFragment(node); break;
				case 0x0032: visitor.OnVariableRuleDefRepetition(node); break;
				case 0x0033: visitor.OnVariableRuleDefTreeAction(node); break;
				case 0x0034: visitor.OnVariableRuleDefElement(node); break;
				case 0x0035: visitor.OnVariableRuleDefAtom(node); break;
				case 0x0036: visitor.OnVariableRuleDefContext(node); break;
				case 0x0037: visitor.OnVariableRuleDefSub(node); break;
				case 0x0038: visitor.OnVariableRuleSymAction(node); break;
				case 0x0039: visitor.OnVariableRuleSymVirtual(node); break;
				case 0x003A: visitor.OnVariableRuleSymRefSimple(node); break;
				case 0x003B: visitor.OnVariableRuleSymRefTemplate(node); break;
				case 0x003C: visitor.OnVariableRuleSymRefParams(node); break;
				case 0x003D: visitor.OnVariableRuleTemplateParams(node); break;
				case 0x004D: visitor.OnVirtualConcat(node); break;
